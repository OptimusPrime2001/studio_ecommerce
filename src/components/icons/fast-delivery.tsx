  ...
  return (
    <svg width='40' height='48' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        strokeWidth='2.5'
      />
      <path d='M20 16H16' stroke='#141718' strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M20 24H12' stroke='#141718' strokeWidth='2.5' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
};

export default FastDelevery;

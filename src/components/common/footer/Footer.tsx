        ...
        <nav className={styles.navigation}>
          {MENU_NAVIGATION.map( ( item ) => (
            <Link
              href={item.href}
              key={item.id}
              className={cn( styles.nav_link, "menu_hover_underline" )}
            >
              {item.label}
            </Link>
          ) )}
      ...
      <div className={styles.footer_bottom}>
        <div className={styles.copyright_section}>
          ...
          <ul className={styles.policy_list}>
            <li>
              <Link href="/terms" className={styles.policy_link}>
                Điều khoản sử dụng
              </Link>
            </li>
            <li>
              <Link href="/return" className={styles.policy_link}>
                Chính sách đổi trả
              </Link>
            </li>
            <li>
              <Link href="/privacy" className={styles.policy_link}>
        ...
        <div className={styles.contact_section}>
          ...
          <p>
            Email:{" "}
            <Link href="mailto:contact@3legant.com">contact@3legant.com</Link>
          </p>
          <p>
        ...
        <div className={styles.category_section}>
          ...
          <ul className={styles.category_list}>
            {categoryData.slice( 1 ).map( ( item ) => (
              <li key={item.id}>
                <Link href={item.href} className={styles.category_link}>
                  {item.name}
                </Link>
              </li>
            ) )}

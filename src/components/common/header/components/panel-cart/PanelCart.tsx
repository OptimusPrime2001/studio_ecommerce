          ...
          <section className={styles.panel_cart_content}>
                ...
                <div key={item} className={styles.cart_content_item}>
                  ...
                  <div className={styles.content_item_left}>
                    ...
                    <div className={styles.item_variant}>
                      <span className={styles.item_variant_text}>Loại: Thiết bị quay chụp</span>
            ...
            <section className={styles.cart_content_summary}>
              <div className={styles.summary_subtotal}>
                <p className={styles.sub_total_note}>Bao gồm thuế. Vận chuyển tính toán khi thanh toán.</p>
                <div className={styles.sub_total_value}>
                  <span >Tổng tiền</span>
                  <span className={styles.sub_total_price}>{formatVnd( 900000 )}</span>
                </div>
              </div>
              <div className={styles.summary_button}>
                <Button className={styles.button_payment}>Thanh toán</Button>
                <Link className={styles.button_view_cart} href='cart-detail'>
                  Xem giỏ hàng
                </Link>
              </div>

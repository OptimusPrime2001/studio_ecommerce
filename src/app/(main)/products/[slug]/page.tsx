    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: 'Sản phẩm rất tuyệt vời, chất lượng hình ảnh sắc nét. Giao hàng nhanh, đóng gói cẩn thận.',
        date: '2024-01-15'
      },
      {
        id: '2',
        userName: 'Trần Thị B',
        rating: 4,
        comment: 'Máy chụp đẹp, tính năng đa dạng. Chỉ có điều pin hơi yếu một chút.',
        date: '2024-01-10'
      },
      {
        id: '3',
      ...
      },
      {
        ...
        userName: 'Phạm Thị D',
        rating: 4,
        comment: 'Sản phẩm tốt, giao diện dễ sử dụng. Hỗ trợ khách hàng nhiệt tình.',
        date: '2024-01-03'
      },
      {
        id: '5',
        ...
        rating: 5,
        comment: 'Chất lượng xuất sắc! Đã sử dụng 2 tháng, rất hài lòng với hiệu suất.',
        date: '2023-12-28'
      }
    ]
  };

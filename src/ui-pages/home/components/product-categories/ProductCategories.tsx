  ...
  return (
    <section className={cn(styles.categories_section, "media_width_sm")}>
      <div className={styles.categories_header}>
        ...
        <p className={styles.categories_subtitle}>
          Khám phá các sản phẩm camera và ánh sáng chuyên nghiệp
        </p>
      </div>
            ...
            {categoryData.map((category, index) => (
              <Link
                ...
                className={cn(
                  ...
                  index === 0 ? styles.category_card_large : "",
                )}
              >
                ...
                <div className={styles.category_info}>
                  <div>
                    ...
                    <p className={styles.category_subname}>
                      {category.subName}
                    </p>
                  </div>
